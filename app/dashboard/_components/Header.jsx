...
function Header() {
  ...
  const handleSignOut = () => {
    setClubName(null); // Clear the clubName in context
    sessionStorage.removeItem("clubName"); // Optional: clear from storage
    ...
    <>
      ...
      >
        ...
        <Link 
          ...
          aria-label="NextGen Recruit Home"
          onClick={closeMobileMenu}
        >
          <Bot className="text-indigo-600" size={28} />
          <span className="text-xl sm:text-2xl font-bold text-indigo-600">NextGen Recruiter</span>
        </Link>
